...
expName = u'spanish_cond1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jacobfisher/projects/inprogress/mm_bilingualism/spanish_cond1.psyexp',
...
text_21 = visual.TextStim(win=win, name='text_21',
    text=u'The audiobook will either be in English or in Spanish.',
    font=u'Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-2.0);
...
trials_2 = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'sounds.xlsx', selection=[2,4]),
